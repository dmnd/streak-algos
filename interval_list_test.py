...
class IntervalList(streaks.StreakAlgo):
    """A cleaner implementation of Checkoff."""

    def __init__(self):
        super(IntervalList, self).__init__()
        self.history = []
        self.updated_utc = streaks.DT_MIN
...
class IntervalListTest(unittest.TestCase, streaks.StreakTestMixin):
    @property
    def user(self):
        return self._user
